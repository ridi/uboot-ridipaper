...
static const NTX_GPIO gt_ntx_gpio_home_key_gp3_26= {
...
static const NTX_GPIO gt_ntx_gpio_pgup_key_gp4_0= {
...
static const NTX_GPIO gt_ntx_gpio_pgdn_key_gp4_2= {
...
static const NTX_GPIO gt_ntx_gpio_fl_key_gp4_3= {
...
static const NTX_GPIO gt_ntx_gpio_r1_key_gp3_24= {
	MX6SL_PAD_KEY_COL0__GPIO_3_24_KEYPAD,  // pin pad/mux control  .
	3, // gpio group .
	24, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_r1_key_gp4_2= {
	MX6SL_PAD_KEY_COL5__GPIO_4_2_KEYPAD,  // pin pad/mux control  .
	4, // gpio group .
	2, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_l1_key_gp4_0= {
	MX6SL_PAD_KEY_COL4__GPIO_4_0_KEYPAD,  // pin pad/mux control  .
	4, // gpio group .
	0, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_r2_key_gp3_30= {
	MX6SL_PAD_KEY_COL3__GPIO_3_30_KEYPAD,  // pin pad/mux control  .
	3, // gpio group .
	30, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_l2_key_gp3_24= {
	MX6SL_PAD_KEY_COL0__GPIO_3_24_KEYPAD,  // pin pad/mux control  .
	3, // gpio group .
	24, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_tp_sw3_26= {
	MX6SL_PAD_KEY_COL0__GPIO_3_24,  // pin pad/mux control .
	3, // gpio group .
	26, // gpio number .
	0, // key down value .
...
static const NTX_GPIO gt_ntx_gpio_power_key_gp4_8= {
	MX6SL_PAD_ECSPI1_SCLK__GPIO_4_8,  // pin pad/mux control .
	4, // gpio group .
	8, // gpio number .
	0, // key down value .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_esdin_5_9= {
	MX6SL_PAD_SD1_DAT5__GPIO_5_9_PULLHIGH,  // pin pad/mux control .
	5, // gpio group .
	9, // gpio number .
	0, // NC .
...
static const NTX_GPIO gt_ntx_gpio_chg_4_10= {
	MX6SL_PAD_ECSPI1_MISO__GPIO_4_10,  // pin pad/mux control .
	4, // gpio group .
	10, // gpio number .
	0, // NC .
	0, // not inited .
...
static NTX_GPIO gt_ntx_gpio_ITEPWR_gp5_13= {
...
static NTX_GPIO gt_ntx_gpio_ITEPWR_gp4_11= {
	MX6SL_PAD_ECSPI1_SS0__GPIO_4_11,  // pin pad/mux control .
	4, // gpio group .
	11, // gpio number .
	0, // default output value .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_ACTION_LED_gp4_12= {
	MX6SL_PAD_ECSPI2_SCLK__GPIO_4_12,  // pin pad/mux control .
	4, // gpio group .
	12, // gpio number .
	0, // default output value .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_WIFI_3V3_ON_1_1= {
	MX6SL_PAD_AUD_RXC__GPIO_1_1,  // pin pad/mux control .
	1, // gpio group .
	1, // gpio number .
	0, // default output value .
	0, // not inited .
...
static NTX_GPIO gt_ntx_gpio_MSPEN_gp5_10= {
	MX6SL_PAD_SD1_DAT7__GPIO_5_10,  // pin pad/mux control .
	5, // gpio group .
	10, // gpio number .
	0, // default output value .
...
static NTX_GPIO gt_ntx_gpio_MSPEN_gp5_7= {
	MX6SL_PAD_SD1_DAT6__GPIO_5_7,  // pin pad/mux control .
	5, // gpio group .
	7, // gpio number .
	0, // default output value .
...
#elif defined ( CONFIG_MX6Q_NTX )
static const NTX_GPIO gt_ntx_gpio_WIFI_3V3_ON= {
	//MX6Q_PAD_GPIO_6__GPIO_1_6,  // pin pad/mux control .
	CONFIG_MX6Q_NTXPAD_GPIO_6__GPIO_1_6,  // pin pad/mux control .
	1, // gpio group .
	6, // gpio number .
	0, // default output value .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_bootcfg_0= {
	...
	CONFIG_MX6Q_NTXPAD_EIM_DA12__GPIO_3_12,  // pin pad/mux control .
	3, // gpio group .
	12, // gpio number .
	0, // NC .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_bootcfg_1= {
	...
	CONFIG_MX6Q_NTXPAD_EIM_DA13__GPIO_3_13,  // pin pad/mux control .
	3, // gpio group .
	13, // gpio number .
	0, // NC .
	0, // not inited .
...
static const NTX_GPIO gt_ntx_gpio_power_key= {
	...
	//CONFIG_MX6Q_NTXPAD_GPIO_2__GPIO_1_2,  // pin pad/mux control .
	1, // gpio group .
	2, // gpio number .
	0, // key down value .
	0, // not inited .
...
void _led_R(int iIsTurnON)
{
	...
	if(31==gptNtxHwCfg->m_val.bPCB||32==gptNtxHwCfg->m_val.bPCB) {
	...
	else if(67==gptNtxHwCfg->m_val.bPCB) {
		// E70Q12 .
		...
		if(5==gptNtxHwCfg->m_val.bLed||6==gptNtxHwCfg->m_val.bLed||7==gptNtxHwCfg->m_val.bLed||8==gptNtxHwCfg->m_val.bLed) {
		...
		else if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,2)) {
			// eMMC@SD2 , IOs@SPI .
		}
			...
			if(55==gptNtxHwCfg->m_val.bPCB) {
				// E70Q02 
				ntx_gpio_set_value(&gt_ntx_gpio_Charge_LED_gp5_9,iIsTurnON?0:1);
			}	
			else if(1==gptNtxHwCfg->m_val.bLed||2==gptNtxHwCfg->m_val.bLed) {
				// RGB/RG type LED .
		...
		61==gptNtxHwCfg->m_val.bPCB)
	{
		...
		if(6==gptNtxHwCfg->m_val.bLed) {
			...
			if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,0)) {
				...
				// eMMC@SD2 ,
				ntx_gpio_set_value(&gt_ntx_gpio_ACTION_LED_gp4_12,iIsTurnON?0:1);
			} 
			else {
				// eMMC@SD4 , IOs@SD1 .
				if(70==gptNtxHwCfg->m_val.bPCB||71==gptNtxHwCfg->m_val.bPCB) {
					// E70Q2X .
...
int ntx_gpio_key_is_fastboot_down(void)
{
	...
	else if(84==gptNtxHwCfg->m_val.bPCB || 80==gptNtxHwCfg->m_val.bPCB // E70Q54 using Power Key + R1 Key
			|| 83==gptNtxHwCfg->m_val.bPCB) // E60QU4 / E60QT4
	{	if(gptNtxGpioKey_R1) {
...
void ntx_hw_early_init(void)
{
	...
	if(13 == gptNtxHwCfg->m_val.bBattery) {
 		if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,2)) {
			ntx_gpio_init(&gt_ntx_gpio_MSPEN_gp5_7);
		}
		else {
			ntx_gpio_init(&gt_ntx_gpio_MSPEN_gp5_10);
		}
	}
...
static void ntx_keys_setup(void)
{
	...
	if (31==gptNtxHwCfg->m_val.bPCB||32==gptNtxHwCfg->m_val.bPCB) {
		...
		if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,2)) {
			// eMMC@SD2 , IOs@SPI
			gptNtxGpioKey_Power = &gt_ntx_gpio_power_key_gp4_8;
		}
		else if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,0)) {
			// eMMC@SD1 , IOs@SD4 .
	...
	else if(84==gptNtxHwCfg->m_val.bPCB) {
		// E70Q5X .
		gptNtxGpioKey_Home = &gt_ntx_gpio_home_key_gp3_26;
	}
	else {
	...
	else if (82==gptNtxHwCfg->m_val.bPCB) {
		// M35QEX .
		gptNtxGpioKey_FL = &gt_ntx_gpio_fl_key_gp4_3;
	}
	else if(25==gptNtxHwCfg->m_val.bKeyPad) {
		// keypad is 'L1+L2+R1+R2+FL'
	...
	if(23==gptNtxHwCfg->m_val.bKeyPad) 
	{
		...
		gptNtxGpioKey_L1 = &gt_ntx_gpio_l1_key_gp4_0;
		gptNtxGpioKey_R2 = &gt_ntx_gpio_r2_key_gp3_30;
		gptNtxGpioKey_L2 = &gt_ntx_gpio_l2_key_gp4_2;
	}
	else
	if(24==gptNtxHwCfg->m_val.bKeyPad)
	{
		if(84==gptNtxHwCfg->m_val.bPCB)
		{
			// keypad is 'L1+L2+R1+R2+HOME'
			gptNtxGpioKey_R1 = &gt_ntx_gpio_r1_key_gp4_2;
			gptNtxGpioKey_L1 = &gt_ntx_gpio_l1_key_gp3_30;
			gptNtxGpioKey_R2 = &gt_ntx_gpio_r2_key_gp4_0;
			gptNtxGpioKey_L2 = &gt_ntx_gpio_l2_key_gp3_24;
		}
		else{
			// keypad is 'L1+L2+R1+R2+HOME'
	...
	if(25==gptNtxHwCfg->m_val.bKeyPad)
	{
		// keypad is 'L1+L2+R1+R2+FL'
		gptNtxGpioKey_R1 = &gt_ntx_gpio_r1_key_gp3_24;
		gptNtxGpioKey_L1 = &gt_ntx_gpio_l1_key_gp4_0;
		gptNtxGpioKey_R2 = &gt_ntx_gpio_r2_key_gp3_30;
		gptNtxGpioKey_L2 = &gt_ntx_gpio_l2_key_gp4_2;
	}	
	...
	{
		// keypad is 'LPGUP+PGDN'
		gptNtxGpioKey_R1 = &gt_ntx_gpio_pgup_key_gp4_0;
		gptNtxGpioKey_R2 = &gt_ntx_gpio_pgdn_key_gp4_2;
	}
	else if(27==gptNtxHwCfg->m_val.bKeyPad)
	{
		// keypad is 'PGUP+PGDN+TP'
		gptNtxGpioKey_R1 = &gt_ntx_gpio_pgup_key_gp4_0;
		gptNtxGpioKey_R2 = &gt_ntx_gpio_pgdn_key_gp4_2;
		gptNtxGpioKey_TPSW = &gt_ntx_gpio_tp_sw3_26;
	}	
...
void ntx_hw_late_init(void) 
{
	...
	if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,2)) {
		// EMMC@SD2 .
		ntx_gpio_init(&gt_ntx_gpio_chg_4_10);
	}
	else 
	if(NTXHWCFG_TST_FLAG(gptNtxHwCfg->m_val.bPCB_Flags2,0)) {
		// EMMC@SD1 .
	...
	else if(64==gptNtxHwCfg->m_val.bPCB || 72==gptNtxHwCfg->m_val.bPCB || 82==gptNtxHwCfg->m_val.bPCB) {
	...
	if(64==gptNtxHwCfg->m_val.bPCB) {
		// C31Q0X
		ntx_gpio_set_value(&gt_ntx_gpio_ITEPWR_gp5_13,0);	// turn off it8951 power
	}
	else if (72==gptNtxHwCfg->m_val.bPCB || 82==gptNtxHwCfg->m_val.bPCB) {
		// M31Q06/M35QEX
		ntx_gpio_set_value(&gt_ntx_gpio_ITEPWR_gp4_11,0);	// turn off it8951 power
	}
