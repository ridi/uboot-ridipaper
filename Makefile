...
mx6sl_ntx_lpddr2-MT42L128M32D1_lan_android_config	\
...
mx6dl_ntx_lpddr2_config        : unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/mx6dl_ntx/config.tmp ; \
			echo "... with iram configuration" ; \
		}
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 mx6dl_ntx freescale mx6
...
E70Q30-LPDDR2-512_config \
E60QJ0-LPDDR2-512_config \
E60QM0-LPDDR2-512_config \
C31Q00-LPDDR2-512_config \
M31Q00-LPDDR2-512_config \
E60QP0-LPDDR2-512_config \
E60QQ0-LPDDR2-512_config \
T05R00-LPDDR2-512_config \
E60K00-LPDDR2-512_config \

$(NTX_BOARD_CONFIGS_LPDDR2_512MB_E60QD0): ntxboard_lpddr2_E60QD0_512MB
#----------------------------------------------------------------------------
NTX_BOARD_CONFIGS_LPDDR2_512MB_M31Q00 = \
M31Q00-LPDDR2-512_config \
M35QE0-LPDDR2-512_config \

$(NTX_BOARD_CONFIGS_LPDDR2_512MB_M31Q00): ntxboard_lpddr2_M31Q00_512MB
#-----------------------------------------------------------------------------
NTX_BOARD_CONFIGS_LPDDR2_1024MB_E60QN0 = \
E60QN0-LPDDR2-1024_config \
E60QR2-LPDDR2-1024_config \

$(NTX_BOARD_CONFIGS_LPDDR2_1024MB_E60QN0): ntxboard_lpddr2_E60QN0_1024MB
#-----------------------------------------------------------------------------
NTX_BOARD_CONFIGS_LPDDR2_1024MB_E70Q10 = \
E70Q10-LPDDR2-1024_config \
E70Q30-LPDDR2-1024_config \
E60QU0-LPDDR2-1024_config \

$(NTX_BOARD_CONFIGS_LPDDR2_1024MB_E70Q10): ntxboard_lpddr2_E70Q10_1024MB
#-----------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
NTX_BOARD_CONFIGS_LPDDR2_2048MB_EA0Q00 = \
EA0Q00-LPDDR2-2048_config \

$(NTX_BOARD_CONFIGS_LPDDR2_2048MB_EA0Q00): ntxboard_lpddr2_EA0Q00_2048MB
#-------------------------------------------------------------------------------

PHONY :=
PHONY += $(NTX_BOARD_CONFIGS_LPDDR2_512MB_E60Q90) $(NTX_BOARD_CONFIGS_LPDDR2_256MB_E60Q90) ${NTX_BOARD_CONFIGS_LPDDR2_512MB_E60Q80} $(NTX_BOARD_CONFIGS_LPDDR2_512MB_E60QD0) $(NTX_BOARD_CONFIGS_LPDDR2_512MB_ED0Q00) $(NTX_BOARD_CONFIGS_DDR3_512MB_E60QJ0) $(NTX_BOARD_CONFIGS_LPDDR2_1024MB_E60QN0) $(NTX_BOARD_CONFIGS_LPDDR2_1024MB_E70Q10) $(NTX_BOARD_CONFIGS_LPDDR2_2048MB_EA0Q00)

PHONY += ntxboard_lpddr2_E60Q90_512MB ntxboard_lpddr2_E60Q90_256MB ntxboard_lpddr2_E60Q80_512MB ntxboard_lpddr2_E60QD0_512MB ntxboard_lpddr2_ED0Q00_512MB ntxboard_ddr3_E60QJ0_512MB ntxboard_lpddr2_E60QN0_1024MB ntxboard_lpddr2_E60Q60_512MB ntxboard_lpddr2_M31Q00_512MB ntxboard_ddr3_E60QJ0_512MB ntxboard_lpddr2_E70Q10_1024MB ntxboard_lpddr2_EA0Q00_2048MB
...
ntxboard_lpddr2_EA0Q00_2048MB: mx6dl_ntx_lpddr2_config
	@cd board/freescale/mx6sl_ntx &&	rm -f flash_header.S &&	ln -s flash_header.EA0Q00.S flash_header.S &&	cd -
...
ntxboard_lpddr2_M31Q00_512MB: mx6sl_ntx_lpddr2-MT42L128M32D1_lan_android_config
	@cd board/freescale/mx6sl_ntx &&	rm -f flash_header.S &&	ln -s flash_header.E60QD0.S flash_header.S &&	cd -
...
ntxboard_lpddr2_E70Q10_1024MB: mx6sl_ntx_lpddr2-NT6TL256T32_config
	@cd board/freescale/mx6sl_ntx &&	rm -f flash_header.S &&	ln -s flash_header.E70Q10.S flash_header.S &&	cd -
