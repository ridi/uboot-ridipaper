...
#define MX6Q_NTXBTN_PAD_CTRL	(PAD_CTL_PKE | PAD_CTL_PUE |	\
		PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_MED | \
		PAD_CTL_DSE_40ohm | PAD_CTL_SRE_FAST | PAD_CTL_HYS)

#define MX6Q_NTXPDBTN_PAD_CTRL	(PAD_CTL_PKE | PAD_CTL_PUE |		\
...
#define  MX6Q_PAD_EIM_D26__GPIO_3_26_PDBTN                             (_MX6Q_PAD_EIM_D26__GPIO_3_26 | MUX_PAD_CTRL(MX6Q_NTXPDBTN_PAD_CTRL))
...
#define  MX6Q_PAD_GPIO_2__GPIO_1_2_BTN                               (_MX6Q_PAD_GPIO_2__GPIO_1_2 | MUX_PAD_CTRL(MX6Q_NTXBTN_PAD_CTRL))
