...
#ifndef _MACH_MX6_MX6SL_PINS_H_
#define _MACH_MX6_MX6SL_PINS_H_
...
#define MX6SL_PAD_FEC_RX_ER__GPIO_4_19                                        \
		IOMUX_PAD(0x0428, 0x0138, 5, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_HSIC_DAT__USB_H_DATA                                        \
		IOMUX_PAD(0x0444, 0x0154, 0, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_HSIC_STROBE__USB_H_STROBE                                   \
		IOMUX_PAD(0x0448, 0x0158, 0, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL0__GPIO_3_24_KEYPAD                                         \
...
#define MX6SL_PAD_KEY_COL2__GPIO_3_28                                         \
		IOMUX_PAD(0x047C, 0x0174, 5, 0x0000, 0, MX6SL_USDHC_PAD_CTRL)
...
#define MX6SL_PAD_KEY_COL3__GPIO_3_30_KEYPAD                                  \
		IOMUX_PAD(0x0480, 0x0178, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_COL4__GPIO_4_0_KEYPAD                                   \
		IOMUX_PAD(0x0484, 0x017C, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_COL5__GPIO_4_2_KEYPAD                                          \
		IOMUX_PAD(0x0488, 0x0180, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_COL7__GPIO_4_6                                          \
		IOMUX_PAD(0x0490, 0x0188, 5, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW0__GPIO_3_25_KEYPAD                                         \
		IOMUX_PAD(0x0494, 0x018C, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW1__GPIO_3_27_KEYPAD                                         \
		IOMUX_PAD(0x0498, 0x0190, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW3__GPIO_3_31_KEYPAD                                         \
		IOMUX_PAD(0x04A0, 0x0198, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW4__GPIO_4_1_KEYPAD                                   \
		IOMUX_PAD(0x04A4, 0x019C, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW5__GPIO_4_3_KEYPAD                                   \
		IOMUX_PAD(0x04A8, 0x01A0, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_KEY_ROW7__GPIO_4_7                                          \
		IOMUX_PAD(0x04B0, 0x01A8, 5, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_SD1_CMD__GPIO_5_14                                          \
		IOMUX_PAD(0x0538, 0x0230, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_SD1_DAT4__GPIO_5_12_FLOAT                                         \
...
#define MX6SL_PAD_SD1_DAT5__GPIO_5_9_FLOAT                                          \
		IOMUX_PAD(0x0550, 0x0248, 5, 0x0000, 0, MX6SL_FLOAT_PAD_CTRL)
#define MX6SL_PAD_SD1_DAT5__GPIO_5_9_PULLHIGH                                          \
		IOMUX_PAD(0x0550, 0x0248, 5, 0x0000, 0, MX6SL_KEYPAD_CTRL)
...
#define MX6SL_PAD_SD2_DAT4__GPIO_5_2                                          \
		IOMUX_PAD(0x0574, 0x026C, 5, 0x0000, 0, MX6SL_USDHC_PAD_CTRL)
...
#define MX6SL_PAD_SD2_DAT6__GPIO_4_29                                         \
		IOMUX_PAD(0x057C, 0x0274, 5, 0x0000, 0, NO_PAD_CTRL)
...
#define MX6SL_PAD_SD2_DAT7__GPIO_5_0                                          \
		IOMUX_PAD(0x0580, 0x0278, 5, 0x0000, 0, NO_PAD_CTRL)
