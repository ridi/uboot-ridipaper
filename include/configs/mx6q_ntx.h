...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"init=/init androidboot.console=ttymxc1 androidboot.hardware=freescale no_console_suspend " \
		"video=mxcfb0:dev=ldb,bpp=32 video=mxcfb1:dev=hdmi,1920x1080M@60,bpp=32 video=mxcfb2:dev=lcd,LCD-XGA,bpp=32 fbmem=45M vmalloc=400M " \
			"rootwait\0"        \
		"bootcmd_mmc=run bootargs_base bootargs_mmc;bootm\0"   \
		"fastboot_dev=mmc0\0" \
		"bootcmd_droid=booti mmc0\0"   \
...
//#define CONFIG_SYS_PROMPT		"MX6Q NTX U-Boot > "
